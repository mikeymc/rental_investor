    ...
    if property[:name] == 'moroni'
      if (property[:updated])
        assert_operating_expenses({
          repairs_and_maintenance: %w(11.6594% $5,465 $66,236 $64,845 $64,132 $65,158 $66,526),
          property_management_fees: %w(4.5000% $2,109 $25,564 $25,027 $24,752 $25,148 $25,676),
          taxes: %w(7.0405% $3,300 $39,996 $39,156 $38,726 $39,345 $40,172),
          insurance: %w(1.7538% $822 $9,963 $9,754 $9,646 $9,801 $10,007),
          salaries_and_wages: %w(4.0536% $1,900 $23,028 $22,545 $22,297 $22,653 $23,129),
          utilities: %w(4.7362% $2,220 $26,906 $26,341 $26,051 $26,468 $27,024),
          water_and_sewer: %w(0.0128% $6 $73 $71 $70 $72 $73),
          trash_removal: %w(0.2881% $135 $1,636 $1,602 $1,584 $1,610 $1,644),
          professional_fees: %w(0.6613% $310 $3,757 $3,678 $3,638 $3,696 $3,773),
          advertising: %w(1.0881% $510 $6,181 $6,052 $5,985 $6,081 $6,208),
          landscaping: %w(0.0224% $11 $127 $125 $123 $125 $128),
          capex: %w(8.0000% $3,750 $45,447 $44,493 $44,003 $44,707 $45,646),
          other_expenses: %w(2.2407% $1,050 $12,729 $12,462 $12,325 $12,522 $12,785),
          total: %w(46.0569% $21,588 $261,644 $256,150 $253,332 $257,385 $262,790)
        })
      else
        assert_operating_expenses({
          repairs_and_maintenance: %w(13.0000% $5,265 $63,180 $61,916 $61,297 $62,217 $63,461),
          property_management_fees: %w(3.5000% $1,418 $17,010 $16,670 $16,503 $16,751 $17,086),
          taxes: %w(7.9013% $3,200 $38,400 $37,632 $37,256 $37,815 $38,571),
          insurance: %w(2.0050% $812 $9,744 $9,549 $9,454 $9,596 $9,788),
          salaries_and_wages: %w(4.4445% $1,800 $21,600 $21,168 $20,957 $21,271 $21,696),
          utilities: %w(5.2345% $2,120 $25,440 $24,931 $24,682 $25,052 $25,553),
          water_and_sewer: %w(0.0123% $5 $60 $59 $58 $59 $60),
          trash_removal: %w(0.3087% $125 $1,500 $1,470 $1,456 $1,477 $1,507),
          professional_fees: %w(0.7407% $300 $3,600 $3,528 $3,492 $3,545 $3,616),
          advertising: %w(1.2346% $500 $6,000 $5,880 $5,821 $5,909 $6,027),
          landscaping: %w(0.0000% $0 $0 $0 $0 $0 $0),
          capex: %w(7.0000% $2,835 $34,020 $33,340 $33,006 $33,501 $34,171),
          other_expenses: %w(2.4691% $1,000 $12,000 $11,760 $11,642 $11,817 $12,053),
          total: %w(47.8507% $19,380 $232,555 $227,904 $225,624 $229,009 $233,589)
        })
      end
    elsif property[:name] == 'sesame'
      assert_operating_expenses({
        repairs_and_maintenance: %w(4.5498% $125 $1,500 $1,470 $1,455 $1,477 $1,507),
        property_management_fees: %w(10.0000% $275 $3,297 $3,231 $3,199 $3,247 $3,312),
        taxes: %w(4.4042% $121 $1,452 $1,423 $1,409 $1,430 $1,458),
        insurance: %w(5.4597% $150 $1,800 $1,764 $1,746 $1,773 $1,808),
        salaries_and_wages: %w(0.0000% $0 $0 $0 $0 $0 $0),
        utilities: %w(0.0000% $0 $0 $0 $0 $0 $0),
        water_and_sewer: %w(0.0000% $0 $0 $0 $0 $0 $0),
        trash_removal: %w(4.5498% $125 $1,500 $1,470 $1,455 $1,477 $1,507),
        professional_fees: %w(0.0000% $0 $0 $0 $0 $0 $0),
        advertising: %w(0.0000% $0 $0 $0 $0 $0 $0),
        landscaping: %w(0.0000% $0 $0 $0 $0 $0 $0),
        capex: %w(7.0000% $192 $2,308 $2,262 $2,239 $2,273 $2,318),
        other_expenses: %w(0.0000% $0 $0 $0 $0 $0 $0),
